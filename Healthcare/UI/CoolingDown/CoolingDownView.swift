...
struct CoolingDownView: View {
    
    private let heartRateManager = HeartRateManager()
    private let avPlayer = AVPlayer(url:  Bundle.main.url(forResource: "Gymnastics", withExtension: "mp4")!)
        ...
        GeometryReader { bodyView in
            VStack {
                ...
                Button(action: {
                    ...
                    NavigationLink(destination: CoolingDownSuccessView()) {
                        Text("次へ")
...
struct CoolingDownView_Previews: PreviewProvider {
